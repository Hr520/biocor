...
<script type="text/javascript">
	function save() {
		var um_msgtitle = $("#um_msgtitle").val();
		if( um_msgtitle==null || um_msgtitle == ""){
			alert("标题不能为空");
			return false;
		}
		var um_msgcontent = $("#um_msgcontent").val();
	...
	<div id="navi">
		<div id='naviDiv'>
			<span><img src="<%=basePath%>/res/images/arror.gif" width="7"
				...
				border="0" alt=""> </span> &nbsp;消息新增&nbsp;
		</div>
	</div>
	<div class="result-wrap">
		<div class="result-content">
			<form method="post" id="form" action="addMessage.do">
				<table class="insert-tab" width="100%">
					<tbody>
					    <tr>
							<th><i class="require-red">*</i>标题</th>
							<td><textarea rows="3" cols="64" name="um_msgtitle" id="um_msgtitle"></textarea>
							</td>
						</tr>
						<tr>
							<th><i class="require-red">*</i>消息内容</th>
							<td><textarea rows="3" cols="64" name="um_msgcontent" id="um_msgcontent"></textarea>
						</tr>
