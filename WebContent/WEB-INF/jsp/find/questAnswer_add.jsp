...
<body>
	...
	<div class="result-wrap">
		<div class="result-content">
			<form method="post" id="form" action="questAnswerAdd.do">
			    <input type="hidden" name="qa_qid" value="${qid }">
				<table class="insert-tab" width="100%">
					<tbody>
					    <tr>
							<th><i class="require-red">*</i>选项</th>
							<td><input class="common-text required" id="qa_no"
								name="qa_no" size="50" value="" type="text">
							</td>
						</tr>
						<tr>
							<th><i class="require-red">*</i>答案内容</th>
							<td>
							    <textarea rows="3" cols="64" name="qa_content" id="qa_content"></textarea>
							</td>
						</tr>
						<tr>
							<th><i class="require-red"></i>备注</th>
							<td>
							    <textarea rows="3" cols="64" name="qa_remark"></textarea>
							</td>
						</tr>
						<tr>
							<th></th>
