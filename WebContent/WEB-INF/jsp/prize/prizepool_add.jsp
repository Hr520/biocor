...
<body>
	...
	<div class="result-wrap">
		<div class="result-content">
			<form method="post" id="form" action="prizePoolAdd.do">
					    ...
					    <tr>
							...
							<td>
							   <input class="common-text required" id="min_money"
							    	name="min_money" size="50" type="text">
							</td>
						</tr>
						<tr>
							...
							<td>
							   <input class="common-text required" id="distributable_min"
							    	name="distributable_min" size="50" type="text">
							</td>
						</tr>
						<tr>
