...
import com.biocor.util.sdk.CCPRestSDK;
...
public class SmsUtil {
	...
	public static void main(String [] args) {
		...
		map.put("phones", "13237137560");
		map.put("modelId", "111300");
		String [] str={"123456"};
		sendTemplateSMS(map,str);
	 ...
	 */
 	public static void sendSms1(String mobile,String code){
	    ...
	    String account = "8a48b551505b4af001505f7e69d80af9", password = "e30f99bc89e8456495cca819f891702b";
		...
		try {
		 ...
		 //System.out.println(PostData);
 	     String ret = SMS(PostData, "https://app.cloopen.com:8883");
	 ...
	 * @param args
	 */
	public static String sendTemplateSMS (Map<String, Object> result,String[] modelparam) {
		try {
			
			CCPRestSDK restAPI = new CCPRestSDK();
			restAPI.init("sandboxapp.cloopen.com", "8883");// 初始化服务器地址和端口，格式如下，服务器地址不需要写https:// 正式
			//restAPI.init("app.cloopen.com", "8883");// 初始化服务器地址和端口，格式如下，服务器地址不需要写https:// 测试
			...
			restAPI.setAppId("8aaf070856b0d2f80156b0dba3270001");// 初始化应用ID
			result = restAPI.sendTemplateSMS(result.get("phones").toString(),result.get("modelId").toString(),modelparam );
