package com.biocor.util.wx.util;
...
public class ConstantUtil {
	...
	//初始化
	public static String APP_ID = "wxe0d8bc5f6ae6365f";//微信开发平台应用id
	public static String APP_SECRET = "5325fd8168409eab4c29290e5729999f";//应用对应的凭证
	//应用对应的密钥
	...
	public static String PARTNER = "1393134502";//财付通商户号
	public static String PARTNER_KEY = "wuhanzongsuokejifazhanyouxiangon";//商户号对应的密钥
	...
	//回调地址
	public static String notify_url = "http://shanmei.518klg.cn:8080/interface/pay/Wechatepay";
}
