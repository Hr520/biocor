package com.biocor.controller.admin.system.menu;
...
public class MenuController extends BaseController {
	...
	@ResponseBody
	public PageData getMenuInfoById(String MENU_ID) throws Exception{
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		try{
			pd = this.getPageData();
	...
	public ModelAndView delMenu(String MENU_ID){
		ModelAndView mv = this.getModelAndView();
